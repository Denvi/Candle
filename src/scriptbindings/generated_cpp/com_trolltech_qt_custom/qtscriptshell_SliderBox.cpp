...
QtScriptShell_SliderBox::QtScriptShell_SliderBox(QWidget*  parent)
    : SliderBox(parent) {}

QtScriptShell_SliderBox::~QtScriptShell_SliderBox() {}

void QtScriptShell_SliderBox::actionEvent(QActionEvent*  event)
{
...
void QtScriptShell_SliderBox::changeEvent(QEvent*  arg__1)
{
...
void QtScriptShell_SliderBox::childEvent(QChildEvent*  event)
{
    QScriptValue _q_function = __qtscript_self.property("childEvent");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("childEvent") & QScriptValue::QObjectMember)) {
        SliderBox::childEvent(event);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_SliderBox::closeEvent(QCloseEvent*  event)
{
...
void QtScriptShell_SliderBox::contextMenuEvent(QContextMenuEvent*  event)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        SliderBox::contextMenuEvent(event);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_SliderBox::customEvent(QEvent*  event)
{
    QScriptValue _q_function = __qtscript_self.property("customEvent");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("customEvent") & QScriptValue::QObjectMember)) {
        SliderBox::customEvent(event);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
int  QtScriptShell_SliderBox::devType() const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return SliderBox::devType();
    } else {
        return qscriptvalue_cast<int >(_q_function.call(__qtscript_self));
    }
}

void QtScriptShell_SliderBox::dragEnterEvent(QDragEnterEvent*  event)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        SliderBox::dragEnterEvent(event);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_SliderBox::dragLeaveEvent(QDragLeaveEvent*  event)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        SliderBox::dragLeaveEvent(event);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_SliderBox::dragMoveEvent(QDragMoveEvent*  event)
{
...
void QtScriptShell_SliderBox::dropEvent(QDropEvent*  event)
{
...
void QtScriptShell_SliderBox::enterEvent(QEvent*  event)
{
...
bool  QtScriptShell_SliderBox::event(QEvent*  event)
{
    QScriptValue _q_function = __qtscript_self.property("event");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("event") & QScriptValue::QObjectMember)) {
        return SliderBox::event(event);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
...
bool  QtScriptShell_SliderBox::eventFilter(QObject*  watched, QEvent*  event)
{
    QScriptValue _q_function = __qtscript_self.property("eventFilter");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("eventFilter") & QScriptValue::QObjectMember)) {
        return SliderBox::eventFilter(watched, event);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        return qscriptvalue_cast<bool >(_q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_SliderBox::focusInEvent(QFocusEvent*  event)
{
...
bool  QtScriptShell_SliderBox::focusNextPrevChild(bool  next)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return SliderBox::focusNextPrevChild(next);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        return qscriptvalue_cast<bool >(_q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_SliderBox::focusOutEvent(QFocusEvent*  event)
{
...
bool  QtScriptShell_SliderBox::hasHeightForWidth() const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return SliderBox::hasHeightForWidth();
    } else {
        return qscriptvalue_cast<bool >(_q_function.call(__qtscript_self));
    }
}

int  QtScriptShell_SliderBox::heightForWidth(int  arg__1) const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return SliderBox::heightForWidth(arg__1);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        return qscriptvalue_cast<int >(_q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_SliderBox::hideEvent(QHideEvent*  event)
{
...
void QtScriptShell_SliderBox::initPainter(QPainter*  painter) const
{
...
void QtScriptShell_SliderBox::inputMethodEvent(QInputMethodEvent*  arg__1)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        SliderBox::inputMethodEvent(arg__1);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
QVariant  QtScriptShell_SliderBox::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return SliderBox::inputMethodQuery(arg__1);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
...
void QtScriptShell_SliderBox::keyPressEvent(QKeyEvent*  event)
{
...
void QtScriptShell_SliderBox::keyReleaseEvent(QKeyEvent*  event)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        SliderBox::keyReleaseEvent(event);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_SliderBox::leaveEvent(QEvent*  event)
{
...
QSize  QtScriptShell_SliderBox::minimumSizeHint() const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return SliderBox::minimumSizeHint();
    } else {
        return qscriptvalue_cast<QSize >(_q_function.call(__qtscript_self));
    }
}

void QtScriptShell_SliderBox::mouseDoubleClickEvent(QMouseEvent*  event)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        SliderBox::mouseDoubleClickEvent(event);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_SliderBox::mouseMoveEvent(QMouseEvent*  event)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        SliderBox::mouseMoveEvent(event);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_SliderBox::mousePressEvent(QMouseEvent*  event)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        SliderBox::mousePressEvent(event);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_SliderBox::mouseReleaseEvent(QMouseEvent*  event)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        SliderBox::mouseReleaseEvent(event);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_SliderBox::moveEvent(QMoveEvent*  event)
{
...
bool  QtScriptShell_SliderBox::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return SliderBox::nativeEvent(eventType, message, result);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        return qscriptvalue_cast<bool >(_q_function.call(__qtscript_self,
            QScriptValueList()
...
QPaintEngine*  QtScriptShell_SliderBox::paintEngine() const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return SliderBox::paintEngine();
    } else {
        return qscriptvalue_cast<QPaintEngine* >(_q_function.call(__qtscript_self));
    }
}

void QtScriptShell_SliderBox::paintEvent(QPaintEvent*  event)
{
...
QPaintDevice*  QtScriptShell_SliderBox::redirected(QPoint*  offset) const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return SliderBox::redirected(offset);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
...
void QtScriptShell_SliderBox::resizeEvent(QResizeEvent*  event)
{
...
QPainter*  QtScriptShell_SliderBox::sharedPainter() const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return SliderBox::sharedPainter();
    } else {
        return qscriptvalue_cast<QPainter* >(_q_function.call(__qtscript_self));
    }
}

void QtScriptShell_SliderBox::showEvent(QShowEvent*  event)
{
...
QSize  QtScriptShell_SliderBox::sizeHint() const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return SliderBox::sizeHint();
    } else {
        return qscriptvalue_cast<QSize >(_q_function.call(__qtscript_self));
    }
}

void QtScriptShell_SliderBox::tabletEvent(QTabletEvent*  event)
{
...
void QtScriptShell_SliderBox::timerEvent(QTimerEvent*  event)
{
    QScriptValue _q_function = __qtscript_self.property("timerEvent");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("timerEvent") & QScriptValue::QObjectMember)) {
        SliderBox::timerEvent(event);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_SliderBox::wheelEvent(QWheelEvent*  event)
{
