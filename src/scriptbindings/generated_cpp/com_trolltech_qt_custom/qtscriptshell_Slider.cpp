...
QtScriptShell_Slider::QtScriptShell_Slider(QWidget*  parent)
    : Slider(parent) {}

QtScriptShell_Slider::~QtScriptShell_Slider() {}

void QtScriptShell_Slider::actionEvent(QActionEvent*  event)
{
...
void QtScriptShell_Slider::changeEvent(QEvent*  e)
{
...
void QtScriptShell_Slider::childEvent(QChildEvent*  event)
{
    QScriptValue _q_function = __qtscript_self.property("childEvent");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("childEvent") & QScriptValue::QObjectMember)) {
        Slider::childEvent(event);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_Slider::closeEvent(QCloseEvent*  event)
{
...
void QtScriptShell_Slider::contextMenuEvent(QContextMenuEvent*  event)
{
...
void QtScriptShell_Slider::customEvent(QEvent*  event)
{
    QScriptValue _q_function = __qtscript_self.property("customEvent");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("customEvent") & QScriptValue::QObjectMember)) {
        Slider::customEvent(event);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
int  QtScriptShell_Slider::devType() const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return Slider::devType();
    } else {
        return qscriptvalue_cast<int >(_q_function.call(__qtscript_self));
    }
}

void QtScriptShell_Slider::dragEnterEvent(QDragEnterEvent*  event)
{
...
void QtScriptShell_Slider::dragLeaveEvent(QDragLeaveEvent*  event)
{
...
void QtScriptShell_Slider::dragMoveEvent(QDragMoveEvent*  event)
{
...
void QtScriptShell_Slider::dropEvent(QDropEvent*  event)
{
...
void QtScriptShell_Slider::enterEvent(QEvent*  event)
{
...
bool  QtScriptShell_Slider::event(QEvent*  event)
{
...
bool  QtScriptShell_Slider::eventFilter(QObject*  watched, QEvent*  event)
{
    QScriptValue _q_function = __qtscript_self.property("eventFilter");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("eventFilter") & QScriptValue::QObjectMember)) {
        return Slider::eventFilter(watched, event);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        return qscriptvalue_cast<bool >(_q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_Slider::focusInEvent(QFocusEvent*  event)
{
...
bool  QtScriptShell_Slider::focusNextPrevChild(bool  next)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return Slider::focusNextPrevChild(next);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        return qscriptvalue_cast<bool >(_q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_Slider::focusOutEvent(QFocusEvent*  event)
{
...
bool  QtScriptShell_Slider::hasHeightForWidth() const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return Slider::hasHeightForWidth();
    } else {
        return qscriptvalue_cast<bool >(_q_function.call(__qtscript_self));
    }
}

int  QtScriptShell_Slider::heightForWidth(int  arg__1) const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return Slider::heightForWidth(arg__1);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        return qscriptvalue_cast<int >(_q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_Slider::hideEvent(QHideEvent*  event)
{
...
void QtScriptShell_Slider::initPainter(QPainter*  painter) const
{
...
void QtScriptShell_Slider::inputMethodEvent(QInputMethodEvent*  arg__1)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        Slider::inputMethodEvent(arg__1);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
QVariant  QtScriptShell_Slider::inputMethodQuery(Qt::InputMethodQuery  arg__1) const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return Slider::inputMethodQuery(arg__1);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
...
void QtScriptShell_Slider::keyPressEvent(QKeyEvent*  ev)
{
...
void QtScriptShell_Slider::keyReleaseEvent(QKeyEvent*  event)
{
...
void QtScriptShell_Slider::leaveEvent(QEvent*  event)
{
...
void QtScriptShell_Slider::mouseDoubleClickEvent(QMouseEvent*  event)
{
...
void QtScriptShell_Slider::mouseMoveEvent(QMouseEvent*  ev)
{
...
void QtScriptShell_Slider::mousePressEvent(QMouseEvent*  ev)
{
...
void QtScriptShell_Slider::mouseReleaseEvent(QMouseEvent*  ev)
{
...
void QtScriptShell_Slider::moveEvent(QMoveEvent*  event)
{
...
bool  QtScriptShell_Slider::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return Slider::nativeEvent(eventType, message, result);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        return qscriptvalue_cast<bool >(_q_function.call(__qtscript_self,
            QScriptValueList()
...
QPaintEngine*  QtScriptShell_Slider::paintEngine() const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return Slider::paintEngine();
    } else {
        return qscriptvalue_cast<QPaintEngine* >(_q_function.call(__qtscript_self));
    }
}

void QtScriptShell_Slider::paintEvent(QPaintEvent*  ev)
{
...
QPaintDevice*  QtScriptShell_Slider::redirected(QPoint*  offset) const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return Slider::redirected(offset);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
...
void QtScriptShell_Slider::resizeEvent(QResizeEvent*  event)
{
...
QPainter*  QtScriptShell_Slider::sharedPainter() const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return Slider::sharedPainter();
    } else {
        return qscriptvalue_cast<QPainter* >(_q_function.call(__qtscript_self));
    }
}

void QtScriptShell_Slider::showEvent(QShowEvent*  event)
{
...
void QtScriptShell_Slider::tabletEvent(QTabletEvent*  event)
{
...
void QtScriptShell_Slider::timerEvent(QTimerEvent*  arg__1)
{
    QScriptValue _q_function = __qtscript_self.property("timerEvent");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("timerEvent") & QScriptValue::QObjectMember)) {
        Slider::timerEvent(arg__1);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_Slider::wheelEvent(QWheelEvent*  e)
{
