...
QtScriptShell_ScriptEdit::QtScriptShell_ScriptEdit(QWidget*  parent)
    : ScriptEdit(parent) {}

QtScriptShell_ScriptEdit::QtScriptShell_ScriptEdit(const QString&  text, QWidget*  parent)
    : ScriptEdit(text, parent) {}

QtScriptShell_ScriptEdit::~QtScriptShell_ScriptEdit() {}

void QtScriptShell_ScriptEdit::actionEvent(QActionEvent*  event)
{
...
bool  QtScriptShell_ScriptEdit::canInsertFromMimeData(const QMimeData*  source) const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return ScriptEdit::canInsertFromMimeData(source);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
...
void QtScriptShell_ScriptEdit::changeEvent(QEvent*  e)
{
...
void QtScriptShell_ScriptEdit::childEvent(QChildEvent*  event)
{
    QScriptValue _q_function = __qtscript_self.property("childEvent");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("childEvent") & QScriptValue::QObjectMember)) {
        ScriptEdit::childEvent(event);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_ScriptEdit::closeEvent(QCloseEvent*  event)
{
...
void QtScriptShell_ScriptEdit::contextMenuEvent(QContextMenuEvent*  e)
{
...
QMimeData*  QtScriptShell_ScriptEdit::createMimeDataFromSelection() const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return ScriptEdit::createMimeDataFromSelection();
    } else {
        return qscriptvalue_cast<QMimeData* >(_q_function.call(__qtscript_self));
    }
}

void QtScriptShell_ScriptEdit::customEvent(QEvent*  event)
{
    QScriptValue _q_function = __qtscript_self.property("customEvent");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("customEvent") & QScriptValue::QObjectMember)) {
        ScriptEdit::customEvent(event);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
int  QtScriptShell_ScriptEdit::devType() const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return ScriptEdit::devType();
    } else {
        return qscriptvalue_cast<int >(_q_function.call(__qtscript_self));
    }
}

void QtScriptShell_ScriptEdit::doSetTextCursor(const QTextCursor&  cursor)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        ScriptEdit::doSetTextCursor(cursor);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_ScriptEdit::dragEnterEvent(QDragEnterEvent*  e)
{
...
void QtScriptShell_ScriptEdit::dragLeaveEvent(QDragLeaveEvent*  e)
{
...
void QtScriptShell_ScriptEdit::dragMoveEvent(QDragMoveEvent*  e)
{
...
void QtScriptShell_ScriptEdit::dropEvent(QDropEvent*  e)
{
...
void QtScriptShell_ScriptEdit::enterEvent(QEvent*  event)
{
...
bool  QtScriptShell_ScriptEdit::event(QEvent*  e)
{
    QScriptValue _q_function = __qtscript_self.property("event");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("event") & QScriptValue::QObjectMember)) {
        return ScriptEdit::event(e);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        return qscriptvalue_cast<bool >(_q_function.call(__qtscript_self,
            QScriptValueList()
...
bool  QtScriptShell_ScriptEdit::eventFilter(QObject*  arg__1, QEvent*  arg__2)
{
    QScriptValue _q_function = __qtscript_self.property("eventFilter");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("eventFilter") & QScriptValue::QObjectMember)) {
        return ScriptEdit::eventFilter(arg__1, arg__2);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        return qscriptvalue_cast<bool >(_q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_ScriptEdit::focusInEvent(QFocusEvent*  e)
{
...
bool  QtScriptShell_ScriptEdit::focusNextPrevChild(bool  next)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return ScriptEdit::focusNextPrevChild(next);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        return qscriptvalue_cast<bool >(_q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_ScriptEdit::focusOutEvent(QFocusEvent*  e)
{
...
bool  QtScriptShell_ScriptEdit::hasHeightForWidth() const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return ScriptEdit::hasHeightForWidth();
    } else {
        return qscriptvalue_cast<bool >(_q_function.call(__qtscript_self));
    }
}

int  QtScriptShell_ScriptEdit::heightForWidth(int  arg__1) const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return ScriptEdit::heightForWidth(arg__1);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        return qscriptvalue_cast<int >(_q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_ScriptEdit::hideEvent(QHideEvent*  event)
{
...
void QtScriptShell_ScriptEdit::initPainter(QPainter*  painter) const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        ScriptEdit::initPainter(painter);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_ScriptEdit::inputMethodEvent(QInputMethodEvent*  arg__1)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        ScriptEdit::inputMethodEvent(arg__1);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
QVariant  QtScriptShell_ScriptEdit::inputMethodQuery(Qt::InputMethodQuery  property) const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return ScriptEdit::inputMethodQuery(property);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
...
void QtScriptShell_ScriptEdit::insertFromMimeData(const QMimeData*  source)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        ScriptEdit::insertFromMimeData(source);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_ScriptEdit::keyPressEvent(QKeyEvent*  e)
{
...
void QtScriptShell_ScriptEdit::keyReleaseEvent(QKeyEvent*  e)
{
...
void QtScriptShell_ScriptEdit::leaveEvent(QEvent*  event)
{
...
QVariant  QtScriptShell_ScriptEdit::loadResource(int  type, const QUrl&  name)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return ScriptEdit::loadResource(type, name);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        return qscriptvalue_cast<QVariant >(_q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_ScriptEdit::mouseDoubleClickEvent(QMouseEvent*  e)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        ScriptEdit::mouseDoubleClickEvent(e);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_ScriptEdit::mouseMoveEvent(QMouseEvent*  e)
{
...
void QtScriptShell_ScriptEdit::mousePressEvent(QMouseEvent*  e)
{
...
void QtScriptShell_ScriptEdit::mouseReleaseEvent(QMouseEvent*  e)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        ScriptEdit::mouseReleaseEvent(e);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_ScriptEdit::moveEvent(QMoveEvent*  event)
{
...
bool  QtScriptShell_ScriptEdit::nativeEvent(const QByteArray&  eventType, void*  message, long*  result)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return ScriptEdit::nativeEvent(eventType, message, result);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        return qscriptvalue_cast<bool >(_q_function.call(__qtscript_self,
            QScriptValueList()
...
QPaintEngine*  QtScriptShell_ScriptEdit::paintEngine() const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return ScriptEdit::paintEngine();
    } else {
        return qscriptvalue_cast<QPaintEngine* >(_q_function.call(__qtscript_self));
    }
}

void QtScriptShell_ScriptEdit::paintEvent(QPaintEvent*  e)
{
...
QPaintDevice*  QtScriptShell_ScriptEdit::redirected(QPoint*  offset) const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return ScriptEdit::redirected(offset);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
...
void QtScriptShell_ScriptEdit::resizeEvent(QResizeEvent*  e)
{
...
void QtScriptShell_ScriptEdit::scrollContentsBy(int  dx, int  dy)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        ScriptEdit::scrollContentsBy(dx, dy);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
void QtScriptShell_ScriptEdit::setupViewport(QWidget*  viewport)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        ScriptEdit::setupViewport(viewport);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
QPainter*  QtScriptShell_ScriptEdit::sharedPainter() const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return ScriptEdit::sharedPainter();
    } else {
        return qscriptvalue_cast<QPainter* >(_q_function.call(__qtscript_self));
    }
}

void QtScriptShell_ScriptEdit::showEvent(QShowEvent*  arg__1)
{
...
void QtScriptShell_ScriptEdit::tabletEvent(QTabletEvent*  event)
{
...
void QtScriptShell_ScriptEdit::timerEvent(QTimerEvent*  e)
{
    QScriptValue _q_function = __qtscript_self.property("timerEvent");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("timerEvent") & QScriptValue::QObjectMember)) {
        ScriptEdit::timerEvent(e);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        _q_function.call(__qtscript_self,
            QScriptValueList()
...
bool  QtScriptShell_ScriptEdit::viewportEvent(QEvent*  arg__1)
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return ScriptEdit::viewportEvent(arg__1);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        return qscriptvalue_cast<bool >(_q_function.call(__qtscript_self,
            QScriptValueList()
...
QSize  QtScriptShell_ScriptEdit::viewportSizeHint() const
{
    ...
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        ...
        return ScriptEdit::viewportSizeHint();
    } else {
        return qscriptvalue_cast<QSize >(_q_function.call(__qtscript_self));
    }
}

void QtScriptShell_ScriptEdit::wheelEvent(QWheelEvent*  e)
{
