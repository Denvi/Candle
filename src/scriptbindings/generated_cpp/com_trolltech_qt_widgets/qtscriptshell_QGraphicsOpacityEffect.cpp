...
void QtScriptShell_QGraphicsOpacityEffect::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QGraphicsOpacityEffect::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QGraphicsOpacityEffect::event(QEvent*  event)
{
...
bool  QtScriptShell_QGraphicsOpacityEffect::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QGraphicsOpacityEffect::timerEvent(QTimerEvent*  event)
{
