...
{
    if ((value >= QTabWidget::Rounded) && (value <= QTabWidget::Triangular))
        return qtscript_QTabWidget_TabShape_keys[static_cast<int>(value)-static_cast<int>(QTabWidget::Rounded)];
    return QString();
}
...
static QScriptValue qtscript_construct_QTabWidget_TabShape(QScriptContext *context, QScriptEngine *engine)
{
    ...
    if ((arg >= QTabWidget::Rounded) && (arg <= QTabWidget::Triangular))
...
{
    if ((value >= QTabWidget::North) && (value <= QTabWidget::East))
        return qtscript_QTabWidget_TabPosition_keys[static_cast<int>(value)-static_cast<int>(QTabWidget::North)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= QTabWidget::North) && (arg <= QTabWidget::East))
