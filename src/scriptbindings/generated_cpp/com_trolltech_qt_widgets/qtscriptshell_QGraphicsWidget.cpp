...
void QtScriptShell_QGraphicsWidget::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QGraphicsWidget::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QGraphicsWidget::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QGraphicsWidget::timerEvent(QTimerEvent*  event)
{
