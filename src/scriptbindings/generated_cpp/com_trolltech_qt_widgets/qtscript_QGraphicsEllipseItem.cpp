...
static QScriptValue qtscript_QGraphicsEllipseItem_static_call(QScriptContext *context, QScriptEngine *)
{
    ...
    if (context->argumentCount() == 0) {
        ...
        QScriptValue _q_result = context->engine()->newVariant(context->thisObject(), QVariant::fromValue((QGraphicsEllipseItem*)_q_cpp_result));
...
QScriptValue qtscript_create_QGraphicsEllipseItem_class(QScriptEngine *engine)
{
    ...
    QScriptValue proto = engine->newVariant(QVariant::fromValue((QGraphicsEllipseItem*)0));
