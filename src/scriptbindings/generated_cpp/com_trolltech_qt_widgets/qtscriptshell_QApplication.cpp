...
void QtScriptShell_QApplication::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QApplication::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QApplication::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QApplication::timerEvent(QTimerEvent*  event)
{
