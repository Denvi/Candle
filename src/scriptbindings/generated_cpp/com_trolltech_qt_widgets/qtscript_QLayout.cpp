...
{
    if ((value >= QLayout::SetDefaultConstraint) && (value <= QLayout::SetMinAndMaxSize))
        return qtscript_QLayout_SizeConstraint_keys[static_cast<int>(value)-static_cast<int>(QLayout::SetDefaultConstraint)];
    return QString();
}
...
static QScriptValue qtscript_construct_QLayout_SizeConstraint(QScriptContext *context, QScriptEngine *engine)
{
    ...
    if ((arg >= QLayout::SetDefaultConstraint) && (arg <= QLayout::SetMinAndMaxSize))
