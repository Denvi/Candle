...
void QtScriptShell_QTextEdit::actionEvent(QActionEvent*  event)
{
...
void QtScriptShell_QTextEdit::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QTextEdit::closeEvent(QCloseEvent*  event)
{
...
void QtScriptShell_QTextEdit::customEvent(QEvent*  event)
{
...
void QtScriptShell_QTextEdit::enterEvent(QEvent*  event)
{
...
void QtScriptShell_QTextEdit::hideEvent(QHideEvent*  event)
{
...
void QtScriptShell_QTextEdit::leaveEvent(QEvent*  event)
{
...
void QtScriptShell_QTextEdit::moveEvent(QMoveEvent*  event)
{
...
void QtScriptShell_QTextEdit::tabletEvent(QTabletEvent*  event)
{
