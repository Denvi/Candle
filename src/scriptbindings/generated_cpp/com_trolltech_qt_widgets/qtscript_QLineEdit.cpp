...
{
    if ((value >= QLineEdit::Normal) && (value <= QLineEdit::PasswordEchoOnEdit))
        return qtscript_QLineEdit_EchoMode_keys[static_cast<int>(value)-static_cast<int>(QLineEdit::Normal)];
    return QString();
}
...
static QScriptValue qtscript_construct_QLineEdit_EchoMode(QScriptContext *context, QScriptEngine *engine)
{
    ...
    if ((arg >= QLineEdit::Normal) && (arg <= QLineEdit::PasswordEchoOnEdit))
