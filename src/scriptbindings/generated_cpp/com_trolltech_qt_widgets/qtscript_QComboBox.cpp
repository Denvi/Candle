...
{
    if ((value >= QComboBox::AdjustToContents) && (value <= QComboBox::AdjustToMinimumContentsLengthWithIcon))
        return qtscript_QComboBox_SizeAdjustPolicy_keys[static_cast<int>(value)-static_cast<int>(QComboBox::AdjustToContents)];
    return QString();
}
...
static QScriptValue qtscript_construct_QComboBox_SizeAdjustPolicy(QScriptContext *context, QScriptEngine *engine)
{
    ...
    if ((arg >= QComboBox::AdjustToContents) && (arg <= QComboBox::AdjustToMinimumContentsLengthWithIcon))
...
{
    if ((value >= QComboBox::NoInsert) && (value <= QComboBox::InsertAlphabetically))
        return qtscript_QComboBox_InsertPolicy_keys[static_cast<int>(value)-static_cast<int>(QComboBox::NoInsert)];
    return QString();
}
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= QComboBox::NoInsert) && (arg <= QComboBox::InsertAlphabetically))
