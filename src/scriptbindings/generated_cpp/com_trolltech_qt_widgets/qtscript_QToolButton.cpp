...
{
    if ((value >= QToolButton::DelayedPopup) && (value <= QToolButton::InstantPopup))
        return qtscript_QToolButton_ToolButtonPopupMode_keys[static_cast<int>(value)-static_cast<int>(QToolButton::DelayedPopup)];
    return QString();
}
...
static QScriptValue qtscript_construct_QToolButton_ToolButtonPopupMode(QScriptContext *context, QScriptEngine *engine)
{
    ...
    if ((arg >= QToolButton::DelayedPopup) && (arg <= QToolButton::InstantPopup))
