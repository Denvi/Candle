...
void QtScriptShell_QShortcut::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QShortcut::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QShortcut::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QShortcut::timerEvent(QTimerEvent*  event)
{
