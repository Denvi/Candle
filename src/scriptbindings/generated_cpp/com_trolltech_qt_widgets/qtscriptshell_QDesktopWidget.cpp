...
void QtScriptShell_QDesktopWidget::actionEvent(QActionEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::closeEvent(QCloseEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::contextMenuEvent(QContextMenuEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::customEvent(QEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::dragEnterEvent(QDragEnterEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::dragLeaveEvent(QDragLeaveEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::dragMoveEvent(QDragMoveEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::dropEvent(QDropEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::enterEvent(QEvent*  event)
{
...
bool  QtScriptShell_QDesktopWidget::event(QEvent*  event)
{
...
bool  QtScriptShell_QDesktopWidget::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::focusInEvent(QFocusEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::focusOutEvent(QFocusEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::hideEvent(QHideEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::keyPressEvent(QKeyEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::keyReleaseEvent(QKeyEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::leaveEvent(QEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::mouseDoubleClickEvent(QMouseEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::mouseMoveEvent(QMouseEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::mousePressEvent(QMouseEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::mouseReleaseEvent(QMouseEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::moveEvent(QMoveEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::paintEvent(QPaintEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::showEvent(QShowEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::tabletEvent(QTabletEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::timerEvent(QTimerEvent*  event)
{
...
void QtScriptShell_QDesktopWidget::wheelEvent(QWheelEvent*  event)
{
