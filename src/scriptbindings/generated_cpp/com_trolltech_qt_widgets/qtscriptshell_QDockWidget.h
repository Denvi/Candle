...
{
public:
    QtScriptShell_QDockWidget(QWidget*  parent = 0, Qt::WindowFlags  flags = Qt::WindowFlags());
    QtScriptShell_QDockWidget(const QString&  title, QWidget*  parent = 0, Qt::WindowFlags  flags = Qt::WindowFlags());
