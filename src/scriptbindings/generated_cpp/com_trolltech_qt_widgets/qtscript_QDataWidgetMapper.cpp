...
{
    if ((value >= QDataWidgetMapper::AutoSubmit) && (value <= QDataWidgetMapper::ManualSubmit))
        return qtscript_QDataWidgetMapper_SubmitPolicy_keys[static_cast<int>(value)-static_cast<int>(QDataWidgetMapper::AutoSubmit)];
    return QString();
}
...
static QScriptValue qtscript_construct_QDataWidgetMapper_SubmitPolicy(QScriptContext *context, QScriptEngine *engine)
{
    ...
    if ((arg >= QDataWidgetMapper::AutoSubmit) && (arg <= QDataWidgetMapper::ManualSubmit))
