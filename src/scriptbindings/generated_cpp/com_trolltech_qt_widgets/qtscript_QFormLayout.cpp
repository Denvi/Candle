...
{
    if ((value >= QFormLayout::FieldsStayAtSizeHint) && (value <= QFormLayout::AllNonFixedFieldsGrow))
        return qtscript_QFormLayout_FieldGrowthPolicy_keys[static_cast<int>(value)-static_cast<int>(QFormLayout::FieldsStayAtSizeHint)];
    return QString();
}
...
static QScriptValue qtscript_construct_QFormLayout_FieldGrowthPolicy(QScriptContext *context, QScriptEngine *engine)
{
    ...
    if ((arg >= QFormLayout::FieldsStayAtSizeHint) && (arg <= QFormLayout::AllNonFixedFieldsGrow))
