...
void QtScriptShell_QGraphicsScene::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QGraphicsScene::customEvent(QEvent*  event)
{
...
void QtScriptShell_QGraphicsScene::timerEvent(QTimerEvent*  event)
{
