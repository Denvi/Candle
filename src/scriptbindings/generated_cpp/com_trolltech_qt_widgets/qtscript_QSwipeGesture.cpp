...
static QString qtscript_QSwipeGesture_SwipeDirection_toStringHelper(QSwipeGesture::SwipeDirection value)
{
    if ((value >= QSwipeGesture::NoDirection) && (value <= QSwipeGesture::Down))
        return qtscript_QSwipeGesture_SwipeDirection_keys[static_cast<int>(value)-static_cast<int>(QSwipeGesture::NoDirection)];
    return QString();
}
...
static QScriptValue qtscript_construct_QSwipeGesture_SwipeDirection(QScriptContext *context, QScriptEngine *engine)
{
    ...
    if ((arg >= QSwipeGesture::NoDirection) && (arg <= QSwipeGesture::Down))
