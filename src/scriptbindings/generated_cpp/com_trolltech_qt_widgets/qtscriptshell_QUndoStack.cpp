...
void QtScriptShell_QUndoStack::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QUndoStack::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QUndoStack::event(QEvent*  event)
{
...
bool  QtScriptShell_QUndoStack::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QUndoStack::timerEvent(QTimerEvent*  event)
{
