...
void QtScriptShell_QMdiArea::actionEvent(QActionEvent*  event)
{
...
void QtScriptShell_QMdiArea::closeEvent(QCloseEvent*  event)
{
...
void QtScriptShell_QMdiArea::customEvent(QEvent*  event)
{
...
void QtScriptShell_QMdiArea::enterEvent(QEvent*  event)
{
...
void QtScriptShell_QMdiArea::focusInEvent(QFocusEvent*  event)
{
...
void QtScriptShell_QMdiArea::focusOutEvent(QFocusEvent*  event)
{
...
void QtScriptShell_QMdiArea::hideEvent(QHideEvent*  event)
{
...
void QtScriptShell_QMdiArea::keyReleaseEvent(QKeyEvent*  event)
{
...
void QtScriptShell_QMdiArea::leaveEvent(QEvent*  event)
{
...
void QtScriptShell_QMdiArea::moveEvent(QMoveEvent*  event)
{
...
void QtScriptShell_QMdiArea::tabletEvent(QTabletEvent*  event)
{
