...
void QtScriptShell_QGraphicsTextItem::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QGraphicsTextItem::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QGraphicsTextItem::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QGraphicsTextItem::timerEvent(QTimerEvent*  event)
{
