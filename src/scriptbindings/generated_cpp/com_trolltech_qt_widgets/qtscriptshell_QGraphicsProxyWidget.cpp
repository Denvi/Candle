...
void QtScriptShell_QGraphicsProxyWidget::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QGraphicsProxyWidget::customEvent(QEvent*  event)
{
...
void QtScriptShell_QGraphicsProxyWidget::timerEvent(QTimerEvent*  event)
{
