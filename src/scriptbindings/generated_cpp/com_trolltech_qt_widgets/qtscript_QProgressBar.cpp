...
{
    if ((value >= QProgressBar::TopToBottom) && (value <= QProgressBar::BottomToTop))
        return qtscript_QProgressBar_Direction_keys[static_cast<int>(value)-static_cast<int>(QProgressBar::TopToBottom)];
    return QString();
}
...
static QScriptValue qtscript_construct_QProgressBar_Direction(QScriptContext *context, QScriptEngine *engine)
{
    ...
    if ((arg >= QProgressBar::TopToBottom) && (arg <= QProgressBar::BottomToTop))
