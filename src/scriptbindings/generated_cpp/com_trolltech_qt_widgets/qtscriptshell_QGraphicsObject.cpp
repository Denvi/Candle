...
void QtScriptShell_QGraphicsObject::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QGraphicsObject::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QGraphicsObject::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QGraphicsObject::timerEvent(QTimerEvent*  event)
{
