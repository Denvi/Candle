...
void QtScriptShell_QItemDelegate::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QItemDelegate::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QItemDelegate::event(QEvent*  event)
{
...
void QtScriptShell_QItemDelegate::timerEvent(QTimerEvent*  event)
{
