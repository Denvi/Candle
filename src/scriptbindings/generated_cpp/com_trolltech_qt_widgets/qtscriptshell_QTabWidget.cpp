...
void QtScriptShell_QTabWidget::actionEvent(QActionEvent*  event)
{
...
void QtScriptShell_QTabWidget::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QTabWidget::closeEvent(QCloseEvent*  event)
{
...
void QtScriptShell_QTabWidget::contextMenuEvent(QContextMenuEvent*  event)
{
...
void QtScriptShell_QTabWidget::customEvent(QEvent*  event)
{
...
void QtScriptShell_QTabWidget::dragEnterEvent(QDragEnterEvent*  event)
{
...
void QtScriptShell_QTabWidget::dragLeaveEvent(QDragLeaveEvent*  event)
{
...
void QtScriptShell_QTabWidget::dragMoveEvent(QDragMoveEvent*  event)
{
...
void QtScriptShell_QTabWidget::dropEvent(QDropEvent*  event)
{
...
void QtScriptShell_QTabWidget::enterEvent(QEvent*  event)
{
...
bool  QtScriptShell_QTabWidget::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QTabWidget::focusInEvent(QFocusEvent*  event)
{
...
void QtScriptShell_QTabWidget::focusOutEvent(QFocusEvent*  event)
{
...
void QtScriptShell_QTabWidget::hideEvent(QHideEvent*  event)
{
...
void QtScriptShell_QTabWidget::keyReleaseEvent(QKeyEvent*  event)
{
...
void QtScriptShell_QTabWidget::leaveEvent(QEvent*  event)
{
...
void QtScriptShell_QTabWidget::mouseDoubleClickEvent(QMouseEvent*  event)
{
...
void QtScriptShell_QTabWidget::mouseMoveEvent(QMouseEvent*  event)
{
...
void QtScriptShell_QTabWidget::mousePressEvent(QMouseEvent*  event)
{
...
void QtScriptShell_QTabWidget::mouseReleaseEvent(QMouseEvent*  event)
{
...
void QtScriptShell_QTabWidget::moveEvent(QMoveEvent*  event)
{
...
void QtScriptShell_QTabWidget::tabletEvent(QTabletEvent*  event)
{
...
void QtScriptShell_QTabWidget::timerEvent(QTimerEvent*  event)
{
...
void QtScriptShell_QTabWidget::wheelEvent(QWheelEvent*  event)
{
