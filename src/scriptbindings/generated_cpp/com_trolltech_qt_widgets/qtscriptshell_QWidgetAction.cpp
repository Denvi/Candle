...
void QtScriptShell_QWidgetAction::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QWidgetAction::customEvent(QEvent*  event)
{
...
void QtScriptShell_QWidgetAction::timerEvent(QTimerEvent*  event)
{
