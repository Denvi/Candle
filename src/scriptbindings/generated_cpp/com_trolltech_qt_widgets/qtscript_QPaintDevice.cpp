...
{
    if ((value >= QPaintDevice::PdmWidth) && (value <= QPaintDevice::PdmDevicePixelRatioScaled))
...
static QScriptValue qtscript_construct_QPaintDevice_PaintDeviceMetric(QScriptContext *context, QScriptEngine *engine)
{
    ...
    if ((arg >= QPaintDevice::PdmWidth) && (arg <= QPaintDevice::PdmDevicePixelRatioScaled))
...
static QScriptValue qtscript_QPaintDevice_prototype_call(QScriptContext *context, QScriptEngine *)
{
    ...
    if (!_q_self) {
        return context->throwError(QScriptContext::TypeError,
            ...
            .arg(qtscript_QPaintDevice_function_names[_id+2]));
    }
    ...
    case 4:
    if (context->argumentCount() == 0) {
        qreal _q_result = _q_self->devicePixelRatioF();
    ...
    return qtscript_QPaintDevice_throw_ambiguity_error_helper(context,
        qtscript_QPaintDevice_function_names[_id+2],
        qtscript_QPaintDevice_function_signatures[_id+2]);
}
...
static QScriptValue qtscript_QPaintDevice_static_call(QScriptContext *context, QScriptEngine *)
{
    ...
    case 1:
    if (context->argumentCount() == 0) {
        qreal _q_result = QPaintDevice::devicePixelRatioFScale();
        return qScriptValueFromValue(context->engine(), _q_result);
    }
    break;
...
QScriptValue qtscript_create_QPaintDevice_class(QScriptEngine *engine)
{
    ...
    for (int i = 0; i < 16; ++i) {
        ...
        proto.setProperty(QString::fromLatin1(qtscript_QPaintDevice_function_names[i+2]),
    ...
    for (int i = 0; i < 1; ++i) {
        QScriptValue fun = engine->newFunction(qtscript_QPaintDevice_static_call,
            qtscript_QPaintDevice_function_lengths[i+1]);
        fun.setData(QScriptValue(engine, uint(0xBABE0000 + i+1)));
        ctor.setProperty(QString::fromLatin1(qtscript_QPaintDevice_function_names[i+1]),
            fun, QScriptValue::SkipInEnumeration);
    }
