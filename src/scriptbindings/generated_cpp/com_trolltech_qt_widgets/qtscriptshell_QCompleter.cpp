...
void QtScriptShell_QCompleter::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QCompleter::customEvent(QEvent*  event)
{
...
void QtScriptShell_QCompleter::timerEvent(QTimerEvent*  event)
{
