...
{
    if ((value >= QSsl::Opaque) && (value <= QSsl::Ec))
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= QSsl::Opaque) && (arg <= QSsl::Ec))
...
{
    if ((value >= QSsl::UnknownProtocol) && (value <= QSsl::TlsV1_2OrLater))
...
{
    int arg = context->argument(0).toInt32();
    if ((arg >= QSsl::UnknownProtocol) && (arg <= QSsl::TlsV1_2OrLater))
