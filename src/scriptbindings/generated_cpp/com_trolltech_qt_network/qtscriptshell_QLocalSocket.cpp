...
void QtScriptShell_QLocalSocket::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QLocalSocket::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QLocalSocket::event(QEvent*  event)
{
...
bool  QtScriptShell_QLocalSocket::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QLocalSocket::timerEvent(QTimerEvent*  event)
{
