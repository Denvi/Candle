...
void QtScriptShell_QUdpSocket::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QUdpSocket::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QUdpSocket::event(QEvent*  event)
{
...
bool  QtScriptShell_QUdpSocket::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QUdpSocket::timerEvent(QTimerEvent*  event)
{
