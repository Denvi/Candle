...
void QtScriptShell_QAbstractSocket::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QAbstractSocket::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QAbstractSocket::event(QEvent*  event)
{
...
bool  QtScriptShell_QAbstractSocket::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QAbstractSocket::timerEvent(QTimerEvent*  event)
{
