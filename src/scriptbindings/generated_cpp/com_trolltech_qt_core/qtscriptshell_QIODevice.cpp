...
void QtScriptShell_QIODevice::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QIODevice::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QIODevice::event(QEvent*  event)
{
...
bool  QtScriptShell_QIODevice::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QIODevice::timerEvent(QTimerEvent*  event)
{
