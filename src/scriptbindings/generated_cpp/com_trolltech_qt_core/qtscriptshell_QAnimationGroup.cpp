...
void QtScriptShell_QAnimationGroup::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QAnimationGroup::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QAnimationGroup::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QAnimationGroup::timerEvent(QTimerEvent*  event)
{
