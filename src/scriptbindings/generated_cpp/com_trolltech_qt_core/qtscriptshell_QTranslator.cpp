...
void QtScriptShell_QTranslator::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QTranslator::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QTranslator::event(QEvent*  event)
{
...
bool  QtScriptShell_QTranslator::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QTranslator::timerEvent(QTimerEvent*  event)
{
