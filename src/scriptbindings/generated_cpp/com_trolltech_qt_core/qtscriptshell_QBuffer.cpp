...
void QtScriptShell_QBuffer::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QBuffer::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QBuffer::event(QEvent*  event)
{
...
bool  QtScriptShell_QBuffer::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QBuffer::timerEvent(QTimerEvent*  event)
{
