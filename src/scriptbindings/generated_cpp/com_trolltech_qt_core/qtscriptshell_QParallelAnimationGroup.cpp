...
void QtScriptShell_QParallelAnimationGroup::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QParallelAnimationGroup::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QParallelAnimationGroup::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QParallelAnimationGroup::timerEvent(QTimerEvent*  event)
{
