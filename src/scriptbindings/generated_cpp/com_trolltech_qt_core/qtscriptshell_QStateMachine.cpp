...
void QtScriptShell_QStateMachine::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QStateMachine::customEvent(QEvent*  event)
{
...
void QtScriptShell_QStateMachine::timerEvent(QTimerEvent*  event)
{
