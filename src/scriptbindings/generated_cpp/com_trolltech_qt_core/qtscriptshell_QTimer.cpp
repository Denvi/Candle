...
void QtScriptShell_QTimer::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QTimer::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QTimer::event(QEvent*  event)
{
...
bool  QtScriptShell_QTimer::eventFilter(QObject*  watched, QEvent*  event)
{
