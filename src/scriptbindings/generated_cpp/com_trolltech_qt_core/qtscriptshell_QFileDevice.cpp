...
void QtScriptShell_QFileDevice::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QFileDevice::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QFileDevice::event(QEvent*  event)
{
    QScriptValue _q_function = __qtscript_self.property("event");
    if (!_q_function.isFunction() || QTSCRIPT_IS_GENERATED_FUNCTION(_q_function)
        || (__qtscript_self.propertyFlags("event") & QScriptValue::QObjectMember)) {
        return QFileDevice::event(event);
    } else {
        QScriptEngine *_q_engine = __qtscript_self.engine();
        return qscriptvalue_cast<bool >(_q_function.call(__qtscript_self,
            QScriptValueList()
...
bool  QtScriptShell_QFileDevice::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QFileDevice::timerEvent(QTimerEvent*  event)
{
