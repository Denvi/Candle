...
void QtScriptShell_QAbstractAnimation::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QAbstractAnimation::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QAbstractAnimation::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QAbstractAnimation::timerEvent(QTimerEvent*  event)
{
