...
void QtScriptShell_QCoreApplication::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QCoreApplication::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QCoreApplication::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QCoreApplication::timerEvent(QTimerEvent*  event)
{
