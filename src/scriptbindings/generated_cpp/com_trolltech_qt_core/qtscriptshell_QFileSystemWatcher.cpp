...
void QtScriptShell_QFileSystemWatcher::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QFileSystemWatcher::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QFileSystemWatcher::event(QEvent*  event)
{
...
bool  QtScriptShell_QFileSystemWatcher::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QFileSystemWatcher::timerEvent(QTimerEvent*  event)
{
