...
void QtScriptShell_QSequentialAnimationGroup::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QSequentialAnimationGroup::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QSequentialAnimationGroup::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QSequentialAnimationGroup::timerEvent(QTimerEvent*  event)
{
