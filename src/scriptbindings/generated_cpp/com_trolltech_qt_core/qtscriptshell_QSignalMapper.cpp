...
void QtScriptShell_QSignalMapper::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QSignalMapper::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QSignalMapper::event(QEvent*  event)
{
...
bool  QtScriptShell_QSignalMapper::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QSignalMapper::timerEvent(QTimerEvent*  event)
{
