...
void QtScriptShell_QSettings::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QSettings::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QSettings::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QSettings::timerEvent(QTimerEvent*  event)
{
