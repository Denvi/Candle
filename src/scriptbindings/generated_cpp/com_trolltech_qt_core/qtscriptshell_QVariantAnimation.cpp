...
void QtScriptShell_QVariantAnimation::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QVariantAnimation::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QVariantAnimation::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QVariantAnimation::timerEvent(QTimerEvent*  event)
{
