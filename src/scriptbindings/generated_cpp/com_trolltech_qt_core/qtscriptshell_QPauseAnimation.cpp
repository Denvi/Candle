...
void QtScriptShell_QPauseAnimation::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QPauseAnimation::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QPauseAnimation::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QPauseAnimation::timerEvent(QTimerEvent*  event)
{
