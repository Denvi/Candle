...
{
    if ((value >= QGradient::LinearGradient) && (value <= QGradient::NoGradient))
        return qtscript_QGradient_Type_keys[static_cast<int>(value)-static_cast<int>(QGradient::LinearGradient)];
    return QString();
}
...
static QScriptValue qtscript_construct_QGradient_Type(QScriptContext *context, QScriptEngine *engine)
{
    ...
    if ((arg >= QGradient::LinearGradient) && (arg <= QGradient::NoGradient))
