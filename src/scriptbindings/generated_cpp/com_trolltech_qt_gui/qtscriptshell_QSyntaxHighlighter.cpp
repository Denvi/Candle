...
void QtScriptShell_QSyntaxHighlighter::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QSyntaxHighlighter::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QSyntaxHighlighter::event(QEvent*  event)
{
...
bool  QtScriptShell_QSyntaxHighlighter::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QSyntaxHighlighter::timerEvent(QTimerEvent*  event)
{
