...
void QtScriptShell_QTextTable::childEvent(QChildEvent*  event)
{
...
void QtScriptShell_QTextTable::customEvent(QEvent*  event)
{
...
bool  QtScriptShell_QTextTable::event(QEvent*  event)
{
...
bool  QtScriptShell_QTextTable::eventFilter(QObject*  watched, QEvent*  event)
{
...
void QtScriptShell_QTextTable::timerEvent(QTimerEvent*  event)
{
