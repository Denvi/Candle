...
{
    if ((value >= QPalette::Active) && (value <= QPalette::All))
        return qtscript_QPalette_ColorGroup_keys[static_cast<int>(value)-static_cast<int>(QPalette::Active)];
    return QString();
}
...
static QScriptValue qtscript_construct_QPalette_ColorGroup(QScriptContext *context, QScriptEngine *engine)
{
    ...
    if ((arg >= QPalette::Active) && (arg <= QPalette::All))
