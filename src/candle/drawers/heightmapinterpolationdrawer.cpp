...
const QVector<QVector<double>> &HeightMapInterpolationDrawer::data() const
{
    return m_data;
}

void HeightMapInterpolationDrawer::setData(const QVector<QVector<double>> &data)
{
    m_data = data;
    update();
}

void HeightMapInterpolationDrawer::clear()
{
    m_data = QVector<QVector<double>>();
}
